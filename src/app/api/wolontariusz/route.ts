...
async function sendEmail(email: string): Promise<Result> {
  ...
  try {
    ...
    const info = await transporter.sendMail({
      ...
      to: email,
      subject: "Płomień Ducha 2025: Rejestracja na wolontariat",
      html: 
      `
        <!DOCTYPE html>
        <html lang="pl">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td align="center" style="padding-top: 20px; font-size: 24px; font-weight: bold;">
                      Dziękujemy za chęć pomocy w organizacji konferencji!
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding-top: 10px; font-size: 18px;">
                      Wkrótce skontaktujemy się, aby przekazać więcej informacji.
                    </td>
                  </tr>
                  <tr>
