...
async function sendEmail(email: string, kid: string): Promise<Result> {
  let isResolved = false;
  let errMessage = '';
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td align="center" style="padding-top: 20px; font-size: 24px; font-weight: bold;">
                      Twoje dziecko – ${kid} zostało zgłoszone na zajęcia!
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding-top: 16px; font-size: 18px;">
                      Dziękujemy za rejestrację! Przed konferencją prześlemy maila zawierającego wszystkie informacje dotyczące organizacji zajęć dla dzieci.
                    </td>
                  </tr>
                  <tr>
...
export async function POST(req: Request) {
  try {
    ...
    const mail = await sendEmail(email, kid);
